...
public class ChestedRedstonePick extends CustomItem {

    private final static String NAME = "chested_redstone_pickaxe";
    private final static Material MATERIAL = Material.IRON_PICKAXE;
    private final static String DEFAULT_TITLE = "Chested redstone pickaxe";
    private final static List<Material> BLOCK_TYPES = List.of(Material.REDSTONE_ORE, Material.DEEPSLATE_REDSTONE_ORE);

    public ChestedRedstonePick() {
