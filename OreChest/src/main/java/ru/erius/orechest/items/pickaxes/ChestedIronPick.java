...
public class ChestedIronPick extends CustomItem {

    private final static String NAME = "chested_iron_pickaxe";
    private final static Material MATERIAL = Material.IRON_PICKAXE;
    private final static String DEFAULT_TITLE = "Chested iron pickaxe";
    private final static List<Material> BLOCK_TYPES = List.of(Material.IRON_ORE, Material.DEEPSLATE_IRON_ORE);

    public ChestedIronPick() {
