...
public class ChestedEmeraldPick extends CustomItem {

    private final static String NAME = "chested_emerald_pickaxe";
    private final static Material MATERIAL = Material.DIAMOND_PICKAXE;
    private final static String DEFAULT_TITLE = "Chested emerald pickaxe";
    private final static List<Material> BLOCK_TYPES = List.of(Material.EMERALD_ORE, Material.DEEPSLATE_EMERALD_ORE);

    public ChestedEmeraldPick() {
